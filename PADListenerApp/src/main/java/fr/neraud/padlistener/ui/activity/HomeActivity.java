	...
	protected BaseHelpManager getHelpManager() {
		return new BaseHelpManager(this, "home", 1) {
			...
			public void buildHelpPages(PageBuilder builder) {
				...
				builder.addHelpPage(R.string.home_help_capture_manual_title, R.string.home_help_capture_manual_content);
				builder.addHelpPage(R.string.home_help_capture_auto_title, R.string.home_help_capture_auto_content);
				builder.addHelpPage(R.string.home_help_sync_manual_title, R.string.home_help_sync_manual_content);
				builder.addHelpPage(R.string.home_help_sync_auto_title, R.string.home_help_sync_auto_content);
				builder.addHelpPage(R.string.home_help_capture_and_sync_auto_title, R.string.home_help_capture_and_sync_auto_content);
				builder.addHelpPage(R.string.home_help_drawer_title, R.string.home_help_drawer_content, ActionViewTarget.Type.TITLE, null);
				builder.addHelpPage(R.string.home_help_settings_title, R.string.home_help_settings_content, new ShowcaseHelpPageModel.HelpPageListener() {
					@Override
